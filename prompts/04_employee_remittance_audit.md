...
Test whether amounts actually deducted from workers for CGA were fully remitted.

Distinguish:

1. legal worker liability;
2. payroll amount actually withheld;
3. contribution revenue recorded by CGA.

Reconcile timing, arrears, corrections, contribution-base definitions and perimeter changes before calling any difference an unexplained remittance gap.

Do not infer that an unexplained gap was spent elsewhere without documentary evidence.
