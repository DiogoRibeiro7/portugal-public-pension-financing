# Acquire and hash primary sources
...
Populate `data/raw/` from the registered official sources.

Priority collections:

- Diário da República legislation;
- CGA annual reports and accounts;
- Conta Geral do Estado / DGO;
- Conta da Segurança Social / IGFSS;
- SIOE/DGAEP public-employment series;
- Tribunal de Contas audits;
- CFP reports;
- Eurostat/European Commission national-accounting material.

For every raw file record URL, retrieval date, SHA-256, reporting period, accounting basis and source ID.

Do not overwrite a file when the issuing institution publishes a revision. Store the revision separately.
