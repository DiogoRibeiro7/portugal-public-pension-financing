...
- notebooks execute in sequence from a clean environment;
- raw source hashes validate;
- no generated evidence is edited manually;
- all figures have companion data;
- manuscript numbers match evidence CSVs;
- README documents known data gaps;
- environment and package versions are pinned for the replication release;
- create a reproducibility report and archive manifest.
