...
Compare employer contributions legally due with contributions recorded as received, by employer class and year.

Create a legal compliance gap and a separate economic benchmark gap.

Never call the economic benchmark a legal debt.
