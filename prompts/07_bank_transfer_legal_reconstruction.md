# Reconstruct the banking-sector pension transfer
...
Build a primary-source timeline for Decree-Law 54/2009, Decree-Law 1-A/2011, Decree-Law 127/2011 and Decree-Law 88/2012.

For Decree-Law 127/2011 extract exactly:

- pensions assumed by Social Security;
- liabilities retained by banks;
- assets transferred to the State;
- financing obligation of the State;
- valuation date;
- 4% legal discount rate;
- mortality tables;
- independent valuation procedure;
- asset-composition constraints;
- transfer schedule;
- list of participating institutions;
- rule extinguishing covered bank liabilities.

Populate `evidence/bank_pension_transfer_registry.csv`.
