# Quantify benefit and risk distribution in the bank transaction
...
Estimate, where data permit, the economic value of the pension liabilities extinguished for each participating bank net of assets surrendered.

Track which risks moved to the public sector and which remained with banks, including pension updates and complementary benefits.
...
- fiscal-accounting effect;
- any demonstrable net subsidy.

Do not infer subsidy from liability transfer alone.
