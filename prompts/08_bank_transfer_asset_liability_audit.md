# Audit transferred bank-pension assets and liabilities
...
For every participating institution obtain the final actuarial liability transferred and the final value/composition of assets delivered.

First reproduce the statutory equality under the 2011 legal assumptions.

Then run sensitivity analysis over discount rates 2%-6% and defensible mortality/longevity assumptions.

Do not call the operation underfunded solely because an alternative discount rate produces a larger liability. Report the sensitivity surface and the economic interpretation.
