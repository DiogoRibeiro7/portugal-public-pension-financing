...
Write the manuscript only from validated article evidence.

Maintain explicit labels for:
...
The paper must remain publishable if the evidence contradicts the initial suspicion that either CGA financing or the 2011 banking-sector pension transfer harmed Social Security.

Do not use newspaper claims as numerical evidence when official data are available.
