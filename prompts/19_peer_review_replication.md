...
Attempt to reproduce every main result from raw sources without reading the manuscript prose first.

Check:

- legal-rate chronology;
- accounting identities;
- bank-transfer perimeter;
- 4% discount-rate implementation;
- ESA-95/ESA-2010 treatment;
- State-specific financing of bank pensions;
- treatment of missing values;
- counterfactual budget consistency;
- claim-registry completeness.

List all conclusions that change under reasonable alternative definitions.
