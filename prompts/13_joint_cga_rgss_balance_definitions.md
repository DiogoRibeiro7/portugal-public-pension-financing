# Reconstruct competing CGA + RGSS balance definitions
...
Implement multiple explicit accounting perimeters rather than one preferred combined balance.

At minimum calculate:

- reported RGSS/previdential balance;
- CGA institutional balance;
- simple combined balance;
- consolidated general-government treatment;
- historically adjusted variants;
- variants that keep bank special-regime obligations separate.

Record every inclusion/exclusion rule in machine-readable form.
