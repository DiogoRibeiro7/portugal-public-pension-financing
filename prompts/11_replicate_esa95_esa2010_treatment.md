# Replicate ESA-95 and ESA-2010 treatment
...
Use official national accounts and the 2011 CGE to reproduce the treatment of the bank pension transfer.

Reproduce or reject the published benchmark that it improved the 2011 ESA-95 headline deficit by about 3.5% of GDP.

Then reproduce the ESA-2010 reclassification as a financial transaction with no direct deficit impact.

Explain why both statements can refer to the same underlying transaction.
