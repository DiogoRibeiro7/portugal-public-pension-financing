...
Implement the preregistered counterfactuals in `evidence/counterfactual_registry.csv`.

Preserve stock-flow consistency.

A hypothetical funded reserve must be treated as additional historical expenditure unless another financing source is explicitly reduced.

For bank pension liabilities, do not compare only asset exhaustion dates; compare the full stream of assets, investment income, State financing and pension expenditure.
