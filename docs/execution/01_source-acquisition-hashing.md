...
- Acquired and hashed the official CGA 2022, 2023, and 2024 annual report PDFs under
  `data/raw/cga/`.
...
official sources, then extended it with the CGA 2022, 2023, and 2024 annual report PDFs.
